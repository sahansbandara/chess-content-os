...
OUTPUT_PATH = PROJECT_ROOT / "logs" / "gemini_bridge10_image_probe.json"
...
- Use standard chess coordinates when you reason about squares.
- Focus only on the FIRST white rook move in this sequence.
...
Rules:
- Do NOT invent other candidate lines.
- Do NOT output SAN notation.
- Judge only from the images.
- If uncertain, still choose the better-supported candidate, but reduce confidence.
...
Return this exact JSON shape:
{
  ...
  "earliest_departure_frame": "frame filename",
  "latest_confirmation_frame": "frame filename",
  "visual_reasoning": [
    "short bullet 1",
    "short bullet 2",
    "short bullet 3"
...
def main() -> int:
    ...
    print()
    print("=== BRIDGE 10 IMAGE PROBE RESULT ===")
